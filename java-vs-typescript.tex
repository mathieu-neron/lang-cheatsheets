...
\begin{construct}{Arrays, sets, maps}
\noindent
\begin{minipage}[t]{0.485\linewidth}
\begin{lstlisting}[style=java, title=Java]
...
xs.push(4); xs[0]; xs.length; xs.shift();
xs.slice(1, 3); [...xs].reverse();

const set = new Set<string>(["a", "b"]);
set.add("c"); set.has("a"); set.delete("b");

const m = new Map<string, number>();
m.set("a", 1); m.get("a") ?? 0;     // getOrDefault
// Plain object as record: { [k: string]: number }
